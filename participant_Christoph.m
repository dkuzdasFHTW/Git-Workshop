function data = participant_Christoph()
...
%   Workshop: Git & MATLAB Versionsmanagement
    ...
    data.y = log(data.x);                       % ← ANPASSEN (Quadratzahlen als Beispiel)
    ...
    data.label  = [data.name, ', f(x) = log(x)'];
