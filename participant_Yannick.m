function data = participant_Yannick()
...
%   Workshop: Git & MATLAB Versionsmanagement
    ...
    data.y = data.x.^ (4);                       % ← ANPASSEN (Quadratzahlen als Beispiel)
